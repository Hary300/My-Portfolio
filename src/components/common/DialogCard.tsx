...
const DialogCard = ({ formStatus, setOpen }: DialogCardProps) => {
  return (
    <DialogContent className='relative sm:max-w-119.75 pt-20 pb-6 lg:pb-8 flex flex-col gap-6 bg-black border rounded-2xl'>
      ...
      <div className='flex flex-col'>
        <p className='font-bold text-lg lg:text-xl'>{formStatus.title}</p>
